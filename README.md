...
Camera movement with right-click dragging.

Smooth painting using left-click + drag.

Random world generation for quick setup.
...
Real-time tile and asset rendering.

Asset scaling based on tile size.

Dynamic UI layout adjusted to window size.
...
Minimap Click → Jump camera to that position

Minimap Drag → Adjust camera smoothly
