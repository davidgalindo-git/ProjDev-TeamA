...
def draw_world(screen_width, grid_bottom_y):
    ...
    max_tile_size_x = screen_width / GRID_WIDTH
    max_tile_size_y = grid_bottom_y / GRID_HEIGHT

    max_possible_tile_size = min(max_tile_size_x, max_tile_size_y)

    TILE_SIZE = max(TILE_SIZE, max_possible_tile_size)
...
def draw_start_screen(screen_width, screen_height):
    ...
    color1 = (50, 150, 50) if btn1_rect.collidepoint(mouse_pos) else (70, 170, 70)
    ...
    color2 = (150,50,50) if btn2_rect.collidepoint(mouse_pos) else (170,70,70)
